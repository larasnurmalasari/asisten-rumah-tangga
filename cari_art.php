...
if (isset($_POST['search'])) {
    $search = $_POST['search'];
    $clean_search = mysqli_real_escape_string($conn, $search);
    $query = "SELECT * FROM si_art WHERE nama LIKE '%$clean_search%' ORDER BY nama ASC";
}
...
<p><a href="index.php">Kembali ke Data art</a></p>
</body>